...
const strengthColor = computed(() => {
  ...
  if (s >= 3) return 'var(--color-success)'
  return 'var(--border)'
})
      ...
      <div class="auth-left" aria-hidden="true">
        <div class="left-content">
          <div class="left-tagline">
            ...
            <h2 class="tagline-title">Amplify your<br><span class="tagline-accent">voice.</span></h2>
            <p class="tagline-desc">Connect with a global audience, share your expertise, and build your portfolio with a beautiful, distraction-free writing experience.</p>
          </div>
          ...
          <div class="left-features">
            <div class="feature-item">
              ...
              <span>Immersive, distraction-free editor</span>
            </div>
            <div class="feature-item">
              <div class="feature-icon">
                <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
              ...
              <span>Fast, responsive, and beautifully designed</span>
            </div>
            <div class="feature-item">
              <div class="feature-icon">
                <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
              ...
              <span>Secure authentication and data privacy</span>
            </div>
          </div>
      ...
      <div class="auth-right">
        <div class="auth-card">
          ...
          <div class="card-header">
            ...
            <p class="auth-subtitle">Start writing and sharing your ideas.</p>
          </div>
          ...
          <div v-if="errorMessage" class="error-card" role="alert">
            ...
            <div class="error-content">
              <span class="error-title">Account Creation Failed</span>
          ...
          <form class="auth-form" @submit.prevent="handleSubmit" novalidate>
                ...
                <div class="field-wrap">
                  <div class="field-icon">
                    <svg width="15" height="15" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                      ...
                      <path d="M3 14c0-3 2.5-5 5-5s5 2 5 5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/>
                    </svg>
                  </div>
                  <input
                    id="first_name"
            ...
            <div class="field">
              <label for="middle_name" class="field-label">
                Middle name <span class="optional-badge">optional</span>
              </label>
              <div class="field-wrap">
                <div class="field-icon">
                  <svg width="15" height="15" viewBox="0 0 16 16" fill="none" aria-hidden="true">
            ...
            <div class="field">
              <div class="field-header">
                ...
                <span v-if="form.password" class="strength-text" :style="{ color: strengthColor }">{{ strengthText }}</span>
              </div>
              <div class="field-wrap">
                <div class="field-icon">
                  <svg width="15" height="15" viewBox="0 0 16 16" fill="none" aria-hidden="true">
              ...
              <div class="strength-bar" v-if="form.password">
                <div class="strength-fill" :style="{ width: `${(passwordStrength / 4) * 100}%`, backgroundColor: strengthColor }"></div>
              </div>
            </div>
            ...
            <div class="field">
              ...
              <div class="field-wrap">
                <div class="field-icon">
                  <svg width="15" height="15" viewBox="0 0 16 16" fill="none" aria-hidden="true">
                    <path d="M1 8h10M7 5l3 3-3 3" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                </div>
                <input
                  id="confirm_password"
          ...
          <p class="auth-switch">
            <NuxtLink to="/login" class="btn-switch">Sign in instead →</NuxtLink>
          </p>
...
.field-input.field-invalid:focus {
  ...
  box-shadow: 0 0 0 3px rgba(240, 96, 96, 0.2);
}
